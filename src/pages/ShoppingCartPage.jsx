    ...
    return (
      <>
       <LoginModal 
          ...
          // onSwitchToSignUp artık gereksiz, kaldırabiliriz
        />

       <div className="mx-auto max-w-[411px] lg:max-w-none w-full">
  ...
  return (
    <>
      <LoginModal 
        ...
        onClose={() => setShowLoginModal(false)}
       />
     <div className="mx-auto max-w-[404px] lg:max-w-none w-full">
        <div className="min-h-screen bg-[#FAFAFA] pb-4">
          ...
          <div className="bg-white border-b border-gray-200">
            <div className="max-w-[1200px] mx-auto px-4 lg:px-6 py-4 lg:py-6">
              ...
              <p className="font-montserrat text-[12px] lg:text-[14px] text-gray-600 mt-1 lg:mt-2">
            ...
            <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
              ...
              <div className="flex-1">
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                  ...
                  <div className="hidden lg:grid lg:grid-cols-12 gap-4 px-6 py-4 bg-gray-50 border-b border-gray-200 font-montserrat font-semibold text-[14px] text-gray-700">
              ...
              {cart.map((item, index) => (
                ...
                >
                  {/* Desktop Layout */}
                  <div className="hidden lg:grid lg:grid-cols-12 gap-4 hover:bg-gray-50 transition">
                    {/* Checkbox */}
